...
public class ParseException extends Exception {
  ...
  private static String initialise(Token currentToken, int[][] expectedTokenSequences, String[] tokenImage) {
    ...
    String retval = file + ": at line " + currentToken.next.beginLine + ", column " + currentToken.next.beginColumn
        + "." + eol + "\t Syntactic error: ";
  ...
  private void printToken(Token t) {
    ...
    if (t == null)
      ...
      System.out.printf("Token %s %d:%d - %s %d:%d\n", tokenImage[t.kind], t.beginLine, t.beginColumn,
          tokenImage[t.next.kind], t.next.beginLine, t.next.beginColumn);
  }
  ...
  private void printToken(int i, Token t) {
    ...
    if (t == null)
      ...
      System.out.printf("Token#%d %s %d:%d null\n", i, tokenImage[t.kind], t.beginLine, t.beginColumn);
    else
...
/* JavaCC - OriginalChecksum=bce3895b92645567e8875b28b7a1997d (do not edit this line) */
